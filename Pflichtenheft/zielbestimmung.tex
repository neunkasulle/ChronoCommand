...
\begin{itemize}
	...
	\item Möglichkeit die erfassten \emp{Zeiten} an den \emph{Administrator*} und \emph{Betreuer*} zu übersenden
	...
	\item \emph{Zeiten} sollen durch eine graphische Übersicht visulisiert werden (Heatmap, Punch Card)
\end{itemize}
