...
public class ChronoCommandException extends Exception {
     ...
     */
    public ChronoCommandException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public ChronoCommandException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public ChronoCommandException(Throwable cause) {
        super(cause);
    }
