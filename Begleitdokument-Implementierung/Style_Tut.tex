...
%% Titelinformationen
\title[GBI in der \theweeknum. Woche]{Grundbegriffe der Informatik \\ Automaten}
%\subtitle{Gehalten in den Tutorien Nr. 1, Nr. 12, Nr. 14 und Nr. 29}
\author[Schmid]{\href{mailto:tutorium@minituex.eu}{Maria Schmid}} %\href{mailto:dominik.doerner@student.kit.edu}{Dominik Doerner} und \href{mailto:allenouyue@hotmail.com}{Yue Ou}}
...
%% Kontakt einfügen
\newcommand{\contact}{\begin{center}Kontakt via E-Mail an \href{mailto:tutorium@minituex.eu}{Maria Schmid}} %\href{mailto:dominik.doerner@student.kit.edu}{Dominik Doerner} oder \href{mailto:allenouyue@hotmail.com}{Yue Ou}\end{center}}
